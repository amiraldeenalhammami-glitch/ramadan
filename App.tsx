...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleCanInstall = () => {
      if (!isAppStandalone) setShowInstallOverlay(true);
    };
  ...
  const handleInstallClick = async () => {
    ...
    if (promptEvent) {
      ...
      alert("التطبيق جاهز للعمل. يمكنك تثبيته يدوياً من قائمة المتصفح (ثلاث نقاط) -> تثبيت التطبيق.");
      setShowInstallOverlay(false);
    }
  };
          ...
          <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl border-4 border-[#fcc52c] relative overflow-hidden">
            ...
            <div className="p-8 text-center space-y-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  {isIOS ? "عرض طريقة التثبيت" : "تنزيل التطبيق الآن"}
                </button>
                <button 
